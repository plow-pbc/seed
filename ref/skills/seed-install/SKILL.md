...
On a non-success terminal reason ([[../../../SEED#^obj-terminal-reasons]]), report partial state to the user: what installed, what didn't, where it stopped. Do not auto-retry. State-machine transitions, terminal reasons, and feedback dispatch all live in `[[../../../SEED#^obj-install-states]]` + `[[../../../SEED#^act-feedback]]`.
